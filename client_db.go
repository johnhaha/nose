...
func (client *NoseDBClient) NewPage(title map[string]string, values map[string]interface{}) (string, error) {
...
func (client *NoseDBClient) SaveData(data interface{}) (string, error) {
